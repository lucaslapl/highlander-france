...
<head>
    ...
    <link rel="stylesheet" href="_css/admin.css"> </head>
<body>
            ...
            <section class="admin-manipulations">
                ...
                <div class="admin-cards-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; margin-top: 20px;">
                    ...
                    <div style="background: #1a1a1a; border: 1px solid #333; padding: 20px; border-radius: 6px;">
                        ...
                        <p style="font-size: 14px; color: #ccc; margin: 0 0 20px 0;">Voir en un clin d'œil la liste complète des utilisateurs possédant un rôle administratif ou d'animation pour vérifier les permissions globales.</p>
                    ...
                    <div style="background: #1a1a1a; border: 1px solid #333; padding: 20px; border-radius: 6px;">
                        <h4 style="margin: 0 0 10px 0; color: #f39c12;"><i class="fa-solid fa-rotate"></i> Synchronisation & CRON</h4>
